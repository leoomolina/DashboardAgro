...
{
    public class GetRankingAsyncQuery(int ano, Agrupamento tipoRanking, int idRegiao, int idUf, TipoLavoura? tipoLavoura, int idProducao) : IRequest<IEnumerable<RankingDashboardDTO>>
    {
        ...
        public Agrupamento TipoRanking { get; set; } = tipoRanking;
    }
}
